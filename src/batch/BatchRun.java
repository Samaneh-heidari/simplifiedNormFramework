...
public class BatchRun {
	...
	private static RunningCondition runningCondition = RunningCondition.NO_DONATION;//TODO:changed
	private static String saveFilePath = "D:\\UU\\reports\\Daily Reports\\Master student\\Maarten\\codes\\NormFramework\\Repast-filesink\\NormFramework\\";
	...
	public static void saveRunData() {
		...
		String datum = initPopList.get(initPopIndex) + "," + batchParameters.get(parameterIndex).toString() ;
	...
	private static ArrayList<BatchParameter> getHypo1BasicPower() {
		...
		saveFilePath = "D:\\UU\\reports\\Daily Reports\\Master student\\Maarten\\codes\\NormFramework\\Repast-filesink\\NormFramework\\";
